...
stroke_test$MRS_discharge_score_cleaned <- median(stroke_test$MRS_discharge_score_cleaned, na.rm = TRUE)
stroke_test$Arrival_NIHSS_score_cleaned <- median(stroke_test$Arrival_NIHSS_score_cleaned, na.rm = TRUE)
stroke_test$Length_of_stay_hours <- median(stroke_test$Length_of_stay_hours, na.rm = TRUE)
stroke_test$BMI <- median(stroke_test$BMI, na.rm = TRUE)
```
