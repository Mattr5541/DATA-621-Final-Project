...
MARJETE - QUESTION: SHOULD THIS NOT BE APPLIED SINCE THERE ARE MANY WEAK CORRELATIONS?

### Creating new variables 
MARJETE - QUESTION- this is usually when 2 variables are strongly correlated but since none are would I skip this part? or combine MRS_discharge_score_cleaned and the NHISS scores?

### Missing data 
MARJETE - QUESTION- do you agree that the median and mode imputation is the right way to go?

last question for now: when transforming the data should I use log since there is range of skewness or box cox? for which variables 
...
Continuous Variables: Length_of_stay_hours (<1%), MRS_discharge_score_cleaned (14%),
